...
DWORD NormalMap::EncodeVectorAsDWORDColor(TVector3* vVector)
{
...
void NormalMap::CreateTangentSpaceVectors(TVector3* v0,
...
void NormalMap::CreateTangentSpaceVectors(TVector3* v1,
	TVector3* v2,
	TVector3* v3,
	float v1u, float v1v,
	float v2u, float v2v,
